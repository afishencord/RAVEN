...
from app.api import audit, auth, automation, credentials, dashboard, flock, incidents, messages, node_groups, nodes, profiles, settings as platform_settings
...
app.include_router(flock.router, prefix=settings.api_prefix)
app.include_router(platform_settings.router, prefix=settings.api_prefix)
