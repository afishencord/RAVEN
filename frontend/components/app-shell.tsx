  ...
  return (
    <div className="flex h-screen w-screen overflow-hidden bg-[#F7F8FB] text-[#111827] dark:bg-[#070B16] dark:text-slate-100">
      ...
      <main className="flex h-screen min-w-0 flex-1 flex-col overflow-hidden">
        <header className="flex h-16 shrink-0 items-center justify-between border-b border-[#E5E7EB] bg-white px-4 shadow-sm dark:border-white/10 dark:bg-[#050814] lg:px-6">
          <div className="flex items-center gap-3">
            <button className="grid h-10 w-10 place-items-center rounded-xl border border-[#E5E7EB] text-slate-600 transition hover:border-[#7C3AED] hover:text-[#7C3AED] dark:border-white/10 dark:text-slate-300 dark:hover:border-purple-500">
          ...
          <div className="flex items-center gap-3">
            <label className="hidden h-10 w-[340px] items-center gap-2 rounded-2xl border border-[#E5E7EB] bg-[#F7F8FB] px-3 text-sm text-[#64748B] shadow-inner dark:border-white/10 dark:bg-white/5 dark:text-slate-400 md:flex">
              ...
              />
              <span className="rounded-md border border-[#E5E7EB] bg-white px-1.5 py-0.5 text-[11px] font-semibold text-[#64748B] dark:border-white/10 dark:bg-[#050814]">⌘ K</span>
            </label>
            <button className="relative grid h-10 w-10 place-items-center rounded-xl border border-[#E5E7EB] bg-white text-slate-600 transition hover:border-[#7C3AED] hover:text-[#7C3AED] dark:border-white/10 dark:bg-white/5 dark:text-slate-300">
        ...
        <div className="min-h-0 flex-1 overflow-y-auto">
          <section className="border-b border-[#E5E7EB] bg-[#F7F8FB] px-4 py-6 dark:border-white/10 dark:bg-[#070B16] lg:px-8">
            <div className="flex flex-col gap-4 xl:flex-row xl:items-end xl:justify-between">
              ...
              <div className="flex flex-wrap items-center gap-3">
                <select className="h-10 rounded-xl border border-[#E5E7EB] bg-white px-3 text-sm font-medium text-[#111827] shadow-sm outline-none transition focus:border-[#7C3AED] dark:border-white/10 dark:bg-[#050814] dark:text-slate-100">
                  <option>Last 24 hours</option>
                  <option>Last 7 days</option>
                  <option>Last 30 days</option>
                </select>
                <button className="inline-flex h-10 items-center gap-2 rounded-xl bg-[#7C3AED] px-4 text-sm font-semibold text-white shadow-[0_10px_22px_rgba(124,58,237,0.25)] transition hover:bg-[#6D28D9]">
      ...
      <Link
        href="/messages"
        className="fixed bottom-6 right-6 z-40 grid h-14 w-14 place-items-center rounded-full bg-[#7C3AED] text-white shadow-[0_18px_40px_rgba(124,58,237,0.35)] transition hover:-translate-y-0.5 hover:bg-[#6D28D9]"
